 ...
 * @param {string} opts.coin[='ltc'] - The coin for this wallet (ltc).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['ltc'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='ltc'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'ltc'] - The coin to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'ltc'] - The coin for this transaction.
